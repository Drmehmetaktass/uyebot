...
async def start(lel, message):
   ...
   but = InlineKeyboardMarkup([[InlineKeyboardMarkup([[InlineKeyboardButton("✅ Giriş", callback_data="Login"), InlineKeyboardButton("✏️ Üye Ekle", callback_data="Adding") ],[InlineKeyboardButton("☎️ Numara Ekle", callback_data="Edit"), InlineKeyboardButton("📛 Numaralar", callback_data="Ish")],[InlineKeyboardButton("🛠️ Numara Sil", callback_data="Remove"), InlineKeyboardButton("✅Admin Panel", callback_data="Admin")]])
